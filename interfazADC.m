...
uicontrol(fig,...
    ...
    'Position',[80 275 170 30],...
    'Callback',@generarTabla1);

uicontrol(fig,...
    'Style','pushbutton',...
    'String','TABLA 2 - MUESTREO',...
    'Position',[270 275 170 30],...
    ...
    try
        ...
        if tipo == "D"
            ...
            resultadoTexto.String = sprintf([...
                'Senal: %s\n',...
                'Fs original = %.0f Hz | Fs seleccionada = %.2f Hz\n',...
                'Ts = %.8f s\n\n',...
                'CUANTIFICACION ORIGINAL DEL WAV\n',...
                'Bits = %d | N = %.0f niveles\n',...
                'MSE = %.10f | SQNR = %.4f dB\n',...
                'Error espectral = %.10f\n\n',...
                'CUANTIFICACION SELECCIONADA\n',...
                'N = %d niveles\n',...
                'MSE = %.10f | SQNR = %.4f dB\n',...
                'Error espectral = %.10f'],...
                ...
                Fs,...
                Ts,...
                resultadoActual.info.BitsPorMuestra,...
                resultadoActual.info.NOriginal,...
                resultadoActual.MSEOriginal,...
                resultadoActual.SNROriginal,...
                resultadoActual.errorRelativoOriginal,...
                N,...
                resultadoActual.MSE,...
                resultadoActual.SNR,...
